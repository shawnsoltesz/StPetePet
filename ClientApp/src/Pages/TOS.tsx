  ...
  return (
    <main>
      ...
      <div className="tos">
        ...
        <h2>OVERVIEW</h2>
        <p>
          This website is operated by StPete.pet. Throughout the site, the terms
          “we”, “us” and “our” refer to StPete.pet. StPete.pet offers this
        ...
        <p>
          ...
          of the service will be accurate or reliable. You agree that from time
        ...
        <p>
          You agree to indemnify, defend and hold harmless StPete.pet and our
