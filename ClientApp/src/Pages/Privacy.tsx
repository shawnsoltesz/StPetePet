  ...
  return (
    <main>
      <div className="privacy">
        ...
        <p>
          This Privacy Policy describes how stpete.pet (the “Site” or “we”)
        ...
        <h3>User Support Information</h3>
        <ul>
          <li>
          ...
          <li>
            <strong>Purpose of collection:</strong> to provide user support.
          </li>
          <li>
        ...
        <p>
          ...
          old. We do not intentionally collect Personal Information from
        ...
        <p>
          ...
          above. We may share your Personal Information to comply with
        ...
        <ul>
          <li>
            ...
            <a href="https://tools.google.com/dlpage/gaoptout" target="blank">
          ...
          <li>
            ...
            partners, such as Facebook and Instagram. We collect and share some
            of this information directly with our advertising partners, and in
            some cases through the use of cookies or other similar technologies
        ...
        <ul>
          <li>
            ...
            <a href="https://www.facebook.com/settings/?tab=ads" target="blank">
        ...
        <p>
          ...
          <a href="http://optout.aboutads.info/" target="blank">
        ...
        <h2>Retention</h2>
        <p>
          When you contact us, we will retain your Personal Information for our
          records unless and until you ask us to erase this information. For
          more information on your right of erasure, please see the ‘Your
        ...
        <p>
          ...
          by e-mail at hello@stpete.pet.
        </p>
        <p>
          <strong>Last updated: December 3, 2021</strong>
        </p>
        <p>
